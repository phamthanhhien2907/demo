...
const ChatBox = ({phone}) => {
  ...
  return (
    <>
       {isMobile ?  theme === "light" ? <div style={{ height: `${height / 2}px` }} className={`${phone ?`flex flex-col gap-2  overflow-scroll scrollbar-hide w-full ` : "flex flex-col gap-2 h-[790px] overflow-scroll scrollbar-hide w-full"}`}>
     ...
     </div> : <div style={{ height: `${height / 2}px` }}  className={`${phone ? `flex flex-col gap-2 h-full  overflow-scroll scrollbar-hide w-full border-none` : "flex flex-col gap-2 h-[790px] overflow-scroll scrollbar-hide w-full"}`}>
